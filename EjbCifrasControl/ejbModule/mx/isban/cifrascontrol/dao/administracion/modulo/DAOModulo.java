...
public interface DAOModulo {
	 ...
	 * momento de realizar acciones relacionadas al modulo
	 */
	...
	/**
	 * Metodo encargado de obtener todos los modulos a los que puede acceder un usuario
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param idUsuario El id de usuario a buscar
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */
	 ...
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param idPantalla El id de pantalla con el que se buscara el modulo relacionado
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */
	 ...
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param idModulo El id del modulo a buscar
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */
	 ...
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param modulo Un objeto de tipo BeanModulo con los datos a modificar
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */
	 ...
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param modulo Un Objeto de tipo BeanModulo con los datos a almacenar
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */
	 ...
	 * @param sessionBean Un objeto de tipo ArchitechSessionBean
	 * @param idModulo El id del modulo que se eliminara
	 * @return Un objeto de tipo BeanModuloRespuesta con el resultado de la operacion en base de datos
	 */

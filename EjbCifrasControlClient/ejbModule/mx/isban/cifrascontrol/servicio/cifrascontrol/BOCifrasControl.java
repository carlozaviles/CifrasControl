...
public interface BOCifrasControl {
	...
	/**
	 * Metodo encargado de realizar la consulta de las cifras de control, para
	 * establecer el listado obtenido y se puedan realizar las siguientes
	 * funcionalidades:
	 * <ul>
	 * <li>Obtener las cifras de control de los aplicativos origen</li>
	 * <li>Obtener las cifras de control del comprobante fiscal digital por
	 * internet</li>
	 ...
	 *
	 * @param aplicativo
	 *            El aplicativo que se utilizara para realizar la consulta
	 * @param periodo
	 *            El periodo a consultar (Anio-Mes p.e 2010-02)
	 * @param sessionBean
	 *            Un objeto de tipo {@link ArchitechSessionBean} necesario por
	 *            la implementacion de Agave
	 * @return El tamanio de la lista obtenida
	 * @throws BusinessException
	 *             En caso de presentarse un error al momento de realizar la
	 *             consulta de las cifras de control
	 */
	 ...
	 * aplicativos (Origen, CFD, EDC, SAT), antes de ejecutar este metodo es
	 * necesario haber ejecutado el metodo consultarCifrasControl
	 * 
	 * @param aplicativo
	 *            La clave del aplicativo del cual se desea obtener el listado
	 * @param sessionBean
	 *            Un objeto de tipo {@link ArchitechSessionBean} necesario por
	 *            la implementacion de Agave

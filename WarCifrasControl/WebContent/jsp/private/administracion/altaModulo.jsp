...
<script src="${pageContext.servletContext.contextPath}/recursos/js/administracion/altaModulo.js" type="text/javascript"></script>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input name="nombreModulo"
							type="text" class="Campos_Des" maxlength="50" id="nombreModulo" /></td><div style="color:#FF0000;" id="nombreRequerido">Ingrese un nombre v&aacute;lido </div>
					</tr>
					<tr>
						<td class="odd">${descripcionModulo}:</td>
						<td colspan="3"><textarea rows="4" cols="50" id="descripcionModulo" name="descripcionModulo"></textarea>(300 caracteres m&aacute;ximo)</td><div style="color:#FF0000;" id="descripcionRequerido">Ingrese una descripcion v&aacute;lida</div>
					</tr>
				</tbody>
			</table>

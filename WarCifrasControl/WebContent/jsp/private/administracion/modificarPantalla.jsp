				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input name="nombrePantalla"
							type="text" class="Campos_Des" maxlength="50" id="nombrePantalla" value="<c:out value="${pantalla.nombrePantalla}"/>"/></td><div style="color:#FF0000;" id="nombreRequerido">${divIngresarNombre}</div>
					</tr>
					<tr>

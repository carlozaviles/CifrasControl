...
<script src="${pageContext.servletContext.contextPath}/recursos/js/administracion/consultaGrupo.js" type="text/javascript"></script>
...
<form action="modificarGrupoInit.do" name="modificar" id="modificar" method="post">
	...
	<div class="framePieContenedor">
		<div class="contentPieContenedor">
			<table>
				<tr>
					<td class="izq"><a href="#" id="detalleGrupo" name="detalleGrupo">${detalle}</td>
				</tr>
			</table>
		</div>
	</div>

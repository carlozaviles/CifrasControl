...
<spring:message code="facturas.formularioRecibos"              var="formularioRecibos"/>
...
<form action="consultaRecibos.do" name="formularioFacturas" id="formularioFacturas" method="post" > 
...
<div class="frameFormularioB">
	<div class="contentFormularioB">
		<div class="titleFormularioB">${modulo} - <span class="textosin">${formularioRecibos}</span></div>
